...
namespace SimonSaysApp.Model.GameFactory
{
	class NormalGameFactory : GameFactory
	{
		...
		public NormalGameFactory(TimeSpan gameOverTime, double sequenceSpeed, List<int> lightIds, List<int> lightSequence)
		{
		...
		{
			return new NormalGame(_gameOverTime, _sequenceSpeed, _lightIds, _lightSequence);
		}
	}
}
